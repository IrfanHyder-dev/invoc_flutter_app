...
class Product extends JsonObject {
  ...
  List<NutrientLevelItem>? nutrientList;

  @JsonKey(name:'nutri_score',includeIfNull: false)
  CategoryNutriScore? categoryNutriScore;
  @JsonKey(name:'nutriscore_score',includeIfNull: false)
  int? currentNutriScore;
  @JsonKey(name: 'environment_impact_level_tags')
