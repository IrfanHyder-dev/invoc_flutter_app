...
import 'package:invoc/v3/auth/common_widgets/form_submit_button.dart';
...
import 'package:invoc/v3/auth/constants/constants.dart';
...
class _EmailLinkSignInPageState extends State<EmailLinkSignInPage> {
  ...
  StreamSubscription<UserFromFirebase>? _onAuthStateChangedSubscription;
  @override
  void initState() {
    super.initState();
    ...
    _onAuthStateChangedSubscription =
        widget.authService.onAuthStateChanged.listen((UserFromFirebase user) {
      if (user != null) {
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              labelText: emailLabelKey.tr,
              hintText: emailHintKey.tr,
              hintStyle: hintStyle,
            ),
            enabled: !isLoading,
