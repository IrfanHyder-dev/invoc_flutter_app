...
import 'package:invoc/v3/auth/app/sign_in/email_password/email_password_sign_in_model.dart';
...
class EmailPasswordSignInPage extends StatefulWidget {
  const EmailPasswordSignInPage._(
      { @required this.model, this.onSignedIn});
      ...
      if (success) {
        if (model.formType == EmailPasswordSignInFormType.forgotPassword) {
          await PlatformAlertDialog(
            title: resetLinkSentTitleKey.tr,
            content: resetLinkSentMessageKey.tr,
        ...
        children: <Widget>[
          ...
          if (model.formType == EmailPasswordSignInFormType.signIn)
            TextButton(
              ...
              child: Text(forgotPasswordQuestionKey.tr),
              onPressed: model.isLoading
                  ? null
                  : () => _updateFormType(
